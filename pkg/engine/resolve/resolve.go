//go:generate mockgen --build_flags=--mod=mod -self_package=github.com/pvormste/graphql-go-tools/pkg/engine/resolve -destination=resolve_mock_test.go -package=resolve . DataSource,BeforeFetchHook,AfterFetchHook,DataSourceBatch,DataSourceBatchFactory
...
import (
	...
	"github.com/pvormste/graphql-go-tools/pkg/fastbuffer"
